...
map('n', '<leader>x', '<CMD>q<CR>', { desc = 'close buffer' })
...
-- QuickFix
map('n', '<M-n>', '<cmd>cnext<CR>', { desc = 'QuickFix Next (:cnext)' })
map('n', '<M-p>', '<cmd>cprev<CR>', { desc = 'QuickFix Prev (:cprev)' })
map('n', '<M-c>', '<cmd>copen<CR>', { desc = 'QuickFix Open (:copen)' })
map('n', '<M-x>', '<cmd>cclose<CR>', { desc = 'QuickFix Close (:cclose)' })

-- CodeCompanion
vim.keymap.set({ 'n', 'v' }, '<LocalLeader>ca', '<cmd>CodeCompanionActions<cr>', { noremap = true, silent = true, desc = 'CodeCompanionActions' })
vim.keymap.set({ 'n', 'v' }, '<LocalLeader>cn', '<cmd>CodeCompanionChat<cr>', { noremap = true, silent = true, desc = 'CodeCompanion New Chat' })
vim.keymap.set({ 'n', 'v' }, '<LocalLeader>cc', '<cmd>CodeCompanionChat Toggle<cr>', { noremap = true, silent = true, desc = 'CodeCompanionChat Toggle' })
vim.keymap.set('n', '<LocalLeader>cs', '<cmd>CodeCompanionSave<cr>', { noremap = true, silent = true, desc = 'CodeCompanionSave' })
vim.keymap.set('n', '<LocalLeader>cq', '<cmd>CodeCompanionSaveQuick<cr>', { noremap = true, silent = true, desc = 'CodeCompanionSaveQuick' })
vim.keymap.set('n', '<LocalLeader>cl', '<cmd>CodeCompanionLoad<cr>', { noremap = true, silent = true, desc = 'CodeCompanionLoad' })
vim.keymap.set('v', '<LocalLeader>cg', ":'<,'>CodeCompanion #{lsp} #{buffer} /doit<cr>", { noremap = true, silent = true, desc = 'CodeCompanion /doit' })
vim.keymap.set(
  'n',
  '<LocalLeader>cd',
  '<cmd>CodeCompanion placement=new #{lsp} #{buffer} /doit<cr>',
  { noremap = true, silent = true, desc = 'CodeCompanion /doit normal mode' }
)
vim.keymap.set(
  'n',
  '<LocalLeader>cx',
  '<cmd>lua require("custom.configs.mini-statusline").stop_codecompanion_spinner()<cr>',
  { noremap = true, silent = true, desc = 'Stop CodeCompanion Spinner' }
)
vim.keymap.set('v', 'ga', '<cmd>CodeCompanionChat Add<cr>', { noremap = true, silent = true, desc = 'CodeCompanionChat Add' })

-- Markview
vim.keymap.set('n', '<leader>m', '<cmd>Markview splitToggle<cr>', { desc = 'Markview Split Toggle' })
vim.keymap.set('n', '<leader>mr', '<cmd>Markview splitRedraw<cr>', { desc = 'Markview Split Redraw' })

-- Dap-ui
vim.keymap.set('n', '<leader>de', '<cmd>lua require("dapui").eval()<cr>', { desc = 'DAP: Evaluate value' })
